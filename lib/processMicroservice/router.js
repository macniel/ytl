...
module.exports = function (options) {
   ...
   */
  this.add({ service: 'process', process: 'list' }, (args, done) => {
    try {
   ...
   */
  this.add({ service: 'process', process: 'info' }, (args, done) => {
    try {
   ...
   */
  this.add({ service: 'process', process: 'update' }, (args, done) => {
    try {
      console.log('UPDATE\t', args.processId, new Date());
