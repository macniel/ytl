...
module.exports = function (options) {
    ...
    this.add({ service: 'tag', tag: 'translate' }, (args, done) => {
        const tagName = args.tagName.trim();
        service.translateTag(tagName, (error, result) => {
            if (!error) {
    ...
    this.add({ service: 'tag', tag: 'get' }, (args, done) => {
    ...
    this.add({ service: 'tag', tag: 'add' }, (args, done) => {
        const tagName = args.tagName.trim();
        const uri = args.uri;
